...
Communication.SendSCI_data('com2',[100, 0, 0, 0, 40])
for i in range(10):
    #发送数据,flag，D1,D2,D3,死区时间
    Communication.SendSCI_data('com2',[10, (i+1)/10, (i+1)/10, (i+1)/10, 40])
    #接收数据并打印，flag,D1,D2,D3
    print("No.{}:".format(i+1),Communication.ReadSCI_data('com2',4))
